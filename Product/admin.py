...
class display_product(admin.ModelAdmin):
    list_display = ['picture','name','priceInput','numberProduct']
    search_fields = ['name']
...
class display_Book(admin.ModelAdmin):
    list_display = ['name','author','publisher','numberProduct','priceInput']
    search_fields = ['name']
class display_Electro(admin.ModelAdmin):

        list_display = ['name', 'colorP', 'producer','national','priceInput', 'numberProduct']
        search_fields = ['name']

class display_Clothes(admin.ModelAdmin):
    search_fields = ['name']
    list_display = ['name', 'colorP', 'sizeP', 'manufacture','priceInput', 'numberProduct']
